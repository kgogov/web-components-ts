    ...
    render() {
        ...
        return html `
			<mty-field-wrapper .labelContent="${this.labelContent}">
				<input @change="${this._onChange}" type="${this.type}" value="${(_a = this.value) !== null && _a !== void 0 ? _a : ''}" placeholder="${(_b = this.placeholder) !== null && _b !== void 0 ? _b : ''}"/>
			</mty-field-wrapper>
		`;
    }
};
